...
<html>
  <head>
	...
	$(function(){
		$("#loginpass").blur(function(){
			...
			$.ajax({
				url:"<%=basePath%>ajaxloginpassword",
				data:{userid:userid,loginpassword:value},
				type:"POST",
				dataType:"json",
				success:function(data) {
					if(data.result==1) {
						$("#ajaxloginpassword").html("原密码不正确！");
					}else{
						$("#ajaxloginpassword").html("");
					}
				},
  ...
  <body>
	...
	<div class="div1">
		<form action="<%=basePath%>updatepassword" method="post" target="_top">
		...
		<table>
			...
			<tr>
				...
				<td><div id="ajaxloginpassword"></div><label id="loginpassError" class="error"></label></td>
			</tr>
			<tr>
				<td align="right">新密码:</td>
				<td><input class="input" type="password" name="loginpassword" id="loginpassword" value=""/></td>
