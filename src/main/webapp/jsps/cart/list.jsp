	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				window.location.href = "${pageContext.request.contextPath}/user/cartitem/deletecartitem.action?cartitemid="+id;
			}
		} else {
...
function sendUpdateQuantity(id, quantity) {
	$.ajax({
		url:"${pageContext.request.contextPath}/user/cartitem/updatecartitemquantity.action",
...
function batchDelete() {
	...
	location = "${pageContext.request.contextPath}/user/cartitem/deletemanycartitem.action?cartItemIds=" + cartItemIdArray;
}
...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		...
		<td align="left" width="70px">
			<a class="linkImage" href="${pageContext.request.contextPath}/user/book/selectonebook.action?bid=${cartItem.book.bid}"><img border="0" width="54" align="top" src="${pageContext.request.contextPath}/user/book/getbookimg.action?bid=${cartItem.book.bid}"/></a>
		</td>
		<td align="left" width="400px">
		    <a href="${pageContext.request.contextPath}/user/book/selectonebook.action?bid=${cartItem.book.bid}"><span>${cartItem.book.bname }</span></a>
		</td>
		...
		<td>
			<a href="${pageContext.request.contextPath}/user/cartitem/deletecartitem.action?cartitemid=${cartItem.cartitemid }">删除</a>
		</td>
	</tr>
</c:forEach>
	...
	<form id="jieSuanForm" action="${pageContext.request.contextPath}/user/cartitem/tijiaodingdan.action" method="post">
